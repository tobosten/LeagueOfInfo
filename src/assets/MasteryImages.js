...
export const MasteryImages = {
    ...
    mastery4: require("./masteryIcons/mastery4.png"),
    mastery5: require("./masteryIcons/mastery5.png"),
    mastery6: require("./masteryIcons/mastery6.png"),
    mastery7: require("./masteryIcons/mastery7.png"),
}